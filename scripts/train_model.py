...
def main():
        ...
        train_ds, val_ds,test_ds=prepare_dataset(train_ds_dir,val_dir=val_ds_dir, test_dir=test_ds_dir,img_height=IMG_HEIGHT,img_width=IMG_WIDTH,batch_size=BATCH_SIZE)
