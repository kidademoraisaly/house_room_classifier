...
def main():
        ...
        train_ds, val_ds,test_ds=load_datasets(train_ds_dir,img_height=IMG_HEIGHT,img_width=IMG_WIDTH,batch_size=BATCH_SIZE)
        ...
        room_classifier.model.save('models/room_classifier_model_pretrained_resnet50_full_training.keras')
